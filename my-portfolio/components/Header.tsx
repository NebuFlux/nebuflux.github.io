...
export const Header = () => {
    ...
    return (
        <div className="relative flex flex-row px-3 h-25 items-end">
            <Image 
            src="https://github.com/NebuFlux.png"
            width={50}
            height={50}
            className="object-left hidden sm:block rounded-full object-cover border-2 border-secondary"
            alt="GitHub Profile Pic"
            />
            <h1 className="text-left text-2xl font-bold ml-5 text-primary">Joshua Shoemaker</h1>
            ...
            <div className="absolute top-full right-0 bg-surface flex flex-col gap-4">
                ...
                ${pathname ==="/" ? "text-primary border-b-2 border-primary" : ""} mr-15`} href="/">
                    Home
                </Link>
                <Link onClick={() => setIsOpen(false)}
                className={`text-xl transition-transform hover:-translate-y-1 
