...
class TemperatureMachine(StateMachine):
    ...
    def setupSerialOutput(self):
        output = (f'{self.current_state.id},{self.getFahrenheit():.1f},'
                  f'{self.setPoint}')
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if altCounter < 6:
                lcd_line_2 = f'T:{self.getFahrenheit():.1f}F'
                altCounter += 1
            else:
...
#
greenButton = Button(24, bounce_time=.1)
...
#
redButton = Button(25, bounce_time=.1)
...
#
blueButton = Button(12, bounce_time=.1)
